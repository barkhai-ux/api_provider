...
describe("/api/v1 proxy", () => {
  ...
  it("rejects unknown, duplicated, missing and out-of-range parameters before calling the API", async () => {
    const cases: [string, string][] = [
      ...
      ["reverse-geocode", "lat=NaN&lon=106.9"],
      ["reverse-geocode", "lat=Infinity&lon=106.9"],
      ["reverse-geocode", "lat=91&lon=106.9"],
      ["reverse-geocode", "lat=1e309&lon=106.9"],
      ["reverse-geocode", "lat=47.9"],
